package com.robotsdna.robot.ui.activity;
...
import com.robotsdna.robot.R;
import com.robotsdna.robot.ui.fragments.intro.IntroFragment;
import com.robotsdna.robot.ui.fragments.main.MainFragment;
import com.robotsdna.robot.ui.fragments.main.OnBackPressedListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Mr","Start to run ros core");
        RosCore rosCore = RosCore.newPrivate();
        rosCore.start();
        Log.d("Mr", String.valueOf(rosCore.getUri()));
//        Log.d("Mr",String.valueOf(mainnode.getDefaultNodeName()));
    }
